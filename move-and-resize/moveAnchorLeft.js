...
// Moves the reference point left in the reference point grid.
// If current reference point is at the left edge, it moves to the
// right edge and one position up (ie from bottom left to centre right).

// my keyboard shortcut: ctrl + opt + cmd + l
