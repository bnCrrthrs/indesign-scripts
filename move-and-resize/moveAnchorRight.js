...
// Moves the reference point right in the reference point grid.
// If current reference point is at the right edge, it moves to the
// left edge and one position down (ie from centre right to bottom left).

// my keyboard shortcut: ctrl + opt + cmd + '
