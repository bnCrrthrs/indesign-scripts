...
// Moves the reference point down in the reference point grid.
// If current reference point is at the bottom, it moves to the top
// and one position right (ie from bottom left to top centre).
